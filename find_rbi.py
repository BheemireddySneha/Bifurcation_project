...
def refine_interactions(df):
    ...
    for i, row in df.iterrows():
        if 'hydrogen bond' in df['inttype'][i]:
            if (row['trbi'] == 'ARG') and ((row['aa1'] == 'NE') or (row['aa1'] == 'NH1') or (row['aa1'] =='NH2')):
                pass
            elif (row['prbi'] == 'ARG') and (row['aa2'] == 'NE' or 'NH1' or 'NH2'):
                pass
            else:
            ...
            if (df['trbi'][i] == 'ASN') and (df['aa1'][i] == 'ND2' or 'OD1'):
                pass
            elif (df['prbi'][i] == 'ASN') and (df['aa2'][i] == 'ND2' or 'OD1'):
                pass
            else:
                df.drop([i], inplace = True)
                i = i+1
            ...
            if (df['trbi'][i] == 'ASP') and (df['aa1'][i] == 'OD1' or 'OD2'):
                pass
            elif (df['prbi'][i] == 'ASP') and (df['aa2'][i] == 'OD1' or 'OD2'):
                pass
            else:
                df.drop([i], inplace = True)
                i = i+1
            ...
            if (df['trbi'][i] == 'GLN') and (df['aa1'][i] == 'OE1' or 'NE2'):
                pass
            elif (df['prbi'][i] == 'GLN') and (df['aa2'][i] == 'OE1' or 'NE2'):
                pass
            else:
                df.drop([i], inplace = True)
                i = i+1
            ...
            if (df['trbi'][i] == 'GLU') and (df['aa1'][i] == 'OE1' or 'OE2'):
                pass
            elif (df['prbi'][i] == 'GLU') and (df['aa2'][i] == 'OE1' or 'OE2'):
                pass
            else:
                df.drop([i], inplace = True)
                i = i+1
            ...
            if (df['trbi'][i] == 'HIS') and (df['aa1'][i] == 'ND1' or 'ND2'):
                pass
            elif (df['prbi'][i] == 'HIS') and (df['aa2'][i] == 'ND1' or 'ND2'):
                pass
            else:
                df.drop([i], inplace = True)
                i = i+1
            ...
            if df['trbi'][i] == 'LYS' and df['aa1'][i] == 'NZ':
                pass
            elif df['prbi'][i] == 'LYS' and df['aa2'][i] == 'NZ':
                pass
            else:
                df.drop([i], inplace = True)
                i = i+1
            ...
            if df['trbi'][i] == 'SER' and df['aa1'][i] == 'OG':
                pass
            elif df['prbi'][i] == 'SER' and df['aa2'][i] == 'OG':
                pass
            else:
                df.drop([i], inplace = True)
                i = i+1
            ...
            if df['trbi'][i] == 'THR' and df['aa1'][i] == 'OG1':
                pass
            elif df['prbi'][i] == 'THR' and df['aa2'][i] == 'OG1':
                pass
            else:
                df.drop([i], inplace = True)
                i = i+1
            ...
            if df['trbi'][i] == 'TRP' and df['aa1'][i] == 'NE1':
                pass
            elif df['prbi'][i] == 'TRP' and df['aa2'][i] == 'NE1':
                pass
            else:
                df.drop([i], inplace = True)
                i = i+1
            ...
            if df['trbi'][i] == 'TYR' and df['aa1'][i] == 'OH':
                pass
            elif df['prbi'][i] == 'TYR' and df['aa2'][i] == 'OH':
                pass
            else:
                df.drop([i], inplace = True)
                i = i+1
...
usage = "USAGE: python3 find_rbi.py --f1 file"
